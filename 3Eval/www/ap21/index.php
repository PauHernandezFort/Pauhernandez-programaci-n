...
<body>
        <?php
                ...
                for ($i=$inicio; $i <= $fin; $i++) {
                    ...
                    echo'<a href="crear.php?id=' . $data["id"] . '"><img src="img/sam.png" alt="" width=50px height=50px ></a>';
                        foreach($data as $element){
                        echo '<td>' . $element . '</td>';
                    }   
                        echo '<td>' . '<a href="delete.php?id=' . $data["id"] . '"><img src="img/delete.png" alt="" width=50px height=50px ></a>' . '</td>';
                        echo '<td>' . '<a href="edit.php?id=' . $data["id"] . '"><img src="img/edit.png" alt="" width=50px height=50px ></a>' . '</td>';
                    echo '</tr>';
