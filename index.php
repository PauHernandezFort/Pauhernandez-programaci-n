    ...
    for ($z=0; $z < $tamaño ; $z++) { 
      ...
      for ($q=0; $q < $tamaño2; $q++) { 
        ...
        for ($z=0; $z < $tamaño ; $z++) { 
          ...
          echo "Se necesitara un total de $litros litros de colirio" ,"<br>";
          $daños = (($impacto_urbano *200000) + ($impacto_tierra *50000));
          echo "El coste de los daños es de $daños €", "<br>";
          $pescado = ($impacto_mar * 2000)/$mar;
          echo "La ONG dispone de $pescado toneladas para vender", "<br>";
          $ganancias = ($pescado *1000) *5;
          echo"la ONG recudara $ganancias €";
